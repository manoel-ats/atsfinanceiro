...
uses
  ...
  DBCtrls, RLReport, RLPreviewForm ;
...
begin
  ...
  //  RLPDFFilter1.FileName := 'C:\home\boletos\manoel.pdf';
   // RLPDFFilter1.FilterPages(FrmRelPedidos.RLReport1.Pages);

   // RLPDFFilter1.FileName := 'c:\Arquivo.PDF' ;
    //RLPDFFilter1.FilterPages( RLReport1.Pages, RLReport1.FirstPageNumber,  RLReport1.LastPageNumber);
    //RLReport1.SaveToFile(FormRelFRLaudoMateriaPrima.RLPDFFilter1.FileName);

   // RLBTitulo1.GerarPDF('C:\home\boletos\'+ cdsBoletoNOMECLIENTE.AsString +'.pdf','autorsss');

   // TLayoutBoleto.


   // LayoutBoleto.LayoutBoleto.SaveToFile('C:\Users\manoel\Desktop\boleto.pdf');

   // BoletoLayout.LayoutBoleto.SaveToFile('C:\nadamesmo.pdf');
