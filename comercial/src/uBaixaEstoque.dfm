inherited fBaixaEstoque: TfBaixaEstoque
  Left = 191
  Top = 133
  Width = 701
  Height = 507
  ...
  object cds: TClientDataSet
    ...
    Left = 488
    Top = 8
    object cdsCODMAT: TIntegerField
      FieldName = 'CODMAT'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    ...
    object cdsCODPRODMP: TIntegerField
      FieldName = 'CODPRODMP'
    end
    object cdsQTDEUSADA: TFloatField
      FieldName = 'QTDEUSADA'
    end
  end
  ...
  object sds: TSQLDataSet
    CommandText = 'select * from MATERIA_PRIMA  '#13#10'where CODPRODUTO = :id'#13#10
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    Left = 424
    Top = 8
    object sdsCODMAT: TIntegerField
      FieldName = 'CODMAT'
      Required = True
    end
    ...
    object sdsCODPRODMP: TIntegerField
      FieldName = 'CODPRODMP'
    end
    object sdsQTDEUSADA: TFloatField
      FieldName = 'QTDEUSADA'
    end
  end
end
