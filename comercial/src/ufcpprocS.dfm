object fCpProcS: TfCpProcS
  Left = 257
  Top = 133
  BorderStyle = bsSingle
  Caption = 'Filtro Contas'
  ClientHeight = 526
  ClientWidth = 792
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = 'N'#186' Eventos'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'NOME'
        Title.Caption = 'Conta Despesa'
        Visible = True
      end>
  end
  ...
  object Panel3: TPanel
    ...
    object JvDBSearchEdit1: TJvDBSearchEdit
      ...
      OnKeyPress = JvDBSearchEdit1KeyPress
    end
    object Edit3: TEdit
      Left = 167
      Top = 86
  ...
  object SQLDataSet1: TSQLDataSet
    CommandText = 
      'select rec.*, forn.NOMEFORNECEDOR, udf_rounddec( (VALORTITULO - ' +
      'VALOR_RESTO),2) as VALORREC ,cli.ra , cli.nomecliente , pl.nome ' +
      'from PAGAMENTO rec '#13#10'inner join FORNECEDOR forn on forn.CODFORNE' +
      'CEDOR = rec.CODFORNECEDOR'#13#10'inner join clientes cli on cli.codcli' +
      'ente = rec.codcliente '#13#10'inner join plano pl on pl.codigo = rec.c' +
      'ontacredito '
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.sqlsisAdimin
  ...
  object scdsCr_proc: TClientDataSet
    ...
    object scdsCr_procNOME: TStringField
      FieldName = 'NOME'
      ReadOnly = True
      Required = True
      Size = 200
  ...
  object cdsSomaRelatorio: TClientDataSet
    Aggregates = <>
    AggregatesActive = True
    Params = <>
  ...
  object sqlProc: TSQLDataSet
    CommandText = 
      'select '#13#10'    pagamento.titulo,'#13#10'    fornecedor.codfornecedor,'#13#10' ' +
      '   fornecedor.nomefornecedor,'#13#10'    movimentodetalhe.valtotal,'#13#10' ' +
      '   clientes.ra,'#13#10'    clientes.nomecliente,'#13#10'    movimentodetalhe' +
      '.outro_credito,'#13#10'    produtos.produto,'#13#10#13#10'    movimentodetalhe.p' +
      'reco,'#13#10'    movimentodetalhe.historico,'#13#10'    movimentodetalhe.dat' +
      'aprocedimento,'#13#10'    movimentodetalhe.datasistema,'#13#10'    compra.da' +
      'tainclusao'#13#10#13#10#13#10'from movimentodetalhe'#13#10'   inner join produtos on' +
      ' (movimentodetalhe.codproduto = produtos.codproduto)'#13#10'   inner j' +
      'oin plano on (produtos.conta_despesa = plano.conta)'#13#10'   inner jo' +
      'in compra on (movimentodetalhe.codmovimento = compra.codmoviment' +
      'o)'#13#10'   inner join pagamento on (compra.codcompra = pagamento.cod' +
      'compra)'#13#10'   inner join fornecedor on (pagamento.codfornecedor = ' +
      'fornecedor.codfornecedor)'#13#10'   inner join clientes on (movimentod' +
      'etalhe.codcliente = clientes.codcliente)'#13#10'where '#13#10'   ('#13#10'      (m' +
      'ovimentodetalhe.codcliente = 1472)'#13#10'   and '#13#10'      (compra.datai' +
      'nclusao between '#39'10/02/13'#39' and '#39'10/02/13'#39')'#13#10'   )'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.sqlsisAdimin
    Left = 576
  ...
  object SQLDataSet5: TSQLDataSet
    CommandText = 'select  sum(valor) from CAIXA_FECHADO'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.sqlsisAdimin
    Left = 344
  ...
  object cds_total1: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DataSetProvider5'
    Left = 406
    Top = 414
    object cds_total1SUM: TFloatField
      FieldName = 'SUM'
      ReadOnly = True
    end
  end
