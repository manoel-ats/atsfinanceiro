object fImpr_Boleto: TfImpr_Boleto
  Left = 198
  Top = 203
  Width = 653
  Height = 271
  ...
  object RadioGroup1: TRadioGroup
    ...
    Width = 509
    Height = 54
    Caption = 'Bancos (Boletos Pr'#233'-Impresso )'
    Columns = 4
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlack
    Font.Height = -13
  ...
  object Bradesco: TVCLReport
    Filename = 'C:\home\sisAdmin\relatorio\boleto_bradesco.rep'
    AsyncExecution = False
    Title = 'Untitled'
    Left = 464
    Top = 16
  end
  object brasil: TVCLReport
    Filename = 'C:\home\sisAdmin\relatorio\boleto_brasil.rep'
    AsyncExecution = False
    Title = 'Untitled'
    Left = 504
    Top = 16
  end
  object repBoleto: TVCLReport
    Filename = 'C:\home\sisAdmin\relatorio\boleto.rep'
    AsyncExecution = False
    Title = 'Untitled'
    Left = 544
    Top = 16
  ...
  object sqlBanco: TSQLDataSet
    ...
    Left = 432
    Top = 16
    object sqlBancoCODBANCO: TSmallintField
      FieldName = 'CODBANCO'
      Required = True
    end
    object sqlBancoBANCO: TStringField
      FieldName = 'BANCO'
      Required = True
      Size = 18
    end
    object sqlBancoNOMEBANCO: TStringField
      FieldName = 'NOMEBANCO'
      Required = True
      Size = 30
    end
    object sqlBancoINSTRUCOES: TGraphicField
      FieldName = 'INSTRUCOES'
      BlobType = ftGraphic
    end
  end
  object caixa: TVCLReport
    Filename = 'C:\home\sisAdmin\relatorio\boleto_caixa.rep'
    AsyncExecution = False
    Title = 'Untitled'
    Left = 592
    Top = 16
