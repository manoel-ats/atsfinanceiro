object fPdm: TfPdm
  ...
  object Label11: TLabel
    ...
    Width = 117
    Height = 13
    Caption = 'Total dos Lan'#231'amentos :'
    Transparent = True
  end
  ...
  object sds_Mov_Det: TSQLDataSet
    CommandText = 
      ...
      'cli.ra , cli.nomecliente'#13#10'from MOVIMENTODETALHE movd '#13#10'inner joi' +
      'n PRODUTOS prod on prod.CODPRODUTO=movd.CODPRODUTO '#13#10'left outer ' +
      'join mov_detalhe_serv mserv on mserv.codmovimento = movd.coddeta' +
      'lhe '#13#10'left outer join ALMOXARIFADO ccus on ccus.CODALMOXARIFADO ' +
      '= prod.CODALMOXARIFADO '#13#10'inner join CLIENTES cli on cli.CODCLIEN' +
      'TE = movd.CONTROLE'#13#10'where movd.CODDETALHE=:CODDETALHE or movd.CO' +
      'DMOVIMENTO=:pCODMOV'
    MaxBlobSize = -1
    Params = <
      item
    ...
    object sds_Mov_DetRA: TStringField
      FieldName = 'RA'
      Size = 10
    end
  ...
  object cds_Mov_det: TClientDataSet
    ...
    object cds_Mov_detRA: TStringField
      FieldName = 'RA'
      Size = 10
    end
