object fNotaFiscalProc: TfNotaFiscalProc
  ...
  object sds: TSQLDataSet
    CommandText = 
      'select nf.IMPRESSA, nf.NOTASERIE, nf.DTAEMISSAO, nf.DTASAIDA, nf' +
      '.UF, nf.NUMNF, nf.NOTAFISCAL, '#13#10'nf.VALOR_TOTAL_NOTA, nf.codClien' +
      'te, case when cli.NOMECLIENTE is null then forn.NOMEFORNECEDOR e' +
      'lse cli.NOMECLIENTE end as CLIFOR, nf.NATUREZA   from NOTAFISCAL' +
      ' nf '#13#10'left outer join CLIENTES cli on  cli.CODCLIENTE = nf.CODCL' +
      'IENTE'#13#10'left outer join FORNECEDOR forn on  forn.CODFORNECEDOR = ' +
      'nf.CODCLIENTE'
    MaxBlobSize = -1
    Params = <>
