inherited fCpAltera2: TfCpAltera2
  Left = 238
  Top = 125
  Width = 789
  Height = 580
  ...
  object sds: TSQLDataSet
    CommandText = 
      'select CODPAGAMENTO, TITULO, EMISSAO, DATAVENCIMENTO, DATAPAGAME' +
      'NTO, CAIXA, CONTACREDITO, STATUS, FORMAPAGAMENTO, DATABAIXA, HIS' +
      'TORICO, CODALMOXARIFADO, N_DOCUMENTO, VALORRECEBIDO, JUROS, DESC' +
      'ONTO, PERDA, FUNRURAL, VALOR_PRIM_VIA, VALOR_RESTO, VALORTITULO,' +
      ' PARCELAS, VIA, (CASE WHEN (VALORRECEBIDO > 0) THEN (VALORTITULO' +
      ' - VALOR_RESTO)'#13#10'  WHEN (VALORRECEBIDO = 0) THEN VALOR_RESTO END' +
      ')'#13#10' as VALORPAG , DATACONSOLIDA'#13#10' from PAGAMENTO WHERE TITULO = ' +
      ':TIT AND CODFORNECEDOR = :CODFOR'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftString
