object fcrProcSaude: TfcrProcSaude
  ...
  object lbl2: TLabel
    ...
    Width = 55
    Height = 13
    Caption = 'Val.Positivo'
  end
  object dbedtSUM: TDBEdit
    Left = 584
    Top = 152
    Width = 97
    Height = 28
  ...
  object cds_total: TClientDataSet
    ...
    Left = 390
    Top = 286
    object cds_totalRECEBIDO: TFloatField
      FieldName = 'RECEBIDO'
      ReadOnly = True
    end
    object cds_totalJUROS: TFloatField
      FieldName = 'JUROS'
      ReadOnly = True
    end
    object cds_totalPENDENTE: TFloatField
      FieldName = 'PENDENTE'
      ReadOnly = True
    end
    object cds_totalDUVIDOSO: TFloatField
      FieldName = 'DUVIDOSO'
      ReadOnly = True
    end
    object cds_totalTOTAL: TFloatField
      FieldName = 'TOTAL'
      ReadOnly = True
    end
    object cds_totalCANCELADO: TFloatField
      FieldName = 'CANCELADO'
      ReadOnly = True
    end
    object cds_totalREEMBOLSO: TFloatField
      FieldName = 'REEMBOLSO'
      ReadOnly = True
    end
    object cds_totalRECEBIDOS: TFloatField
      FieldName = 'RECEBIDOS'
      ReadOnly = True
    end
  end
  ...
  object sds_total: TSQLDataSet
    CommandText = 
      'SELECT '#13#10' SUM(rec.VALORRECEBIDO + rec.JUROS) as RECEBIDO,  '#13#10' SU' +
      'M((rec.VALORRECEBIDO + rec.JUROS)-(REC.DESCONTO*-1)) as RECEBIDO' +
      'S ,'#13#10'       SUM(rec.JUROS) as JUROS,  '#13#10'       SUM(CASE WHEN (re' +
      'c.STATUS = '#39'5-'#39') THEN REC.VALOR_RESTO ELSE 0 END) AS PENDENTE,  ' +
      #13#10'       SUM(CASE WHEN (rec.STATUS = '#39'8-'#39') THEN REC.VALOR_RESTO ' +
      'ELSE 0 END) AS DUVIDOSO,  '#13#10'       SUM(CASE WHEN (rec.STATUS = '#39 +
      '7-'#39') THEN (REC.VALOR_RESTO - rec.VALORRECEBIDO) ELSE REC.VALOR_R' +
      'ESTO END) AS TOTAL,  '#13#10'       SUM(CASE WHEN (rec.STATUS = '#39'14'#39') ' +
      'THEN (REC.VALOR_RESTO ) ELSE 0 END)  AS CANCELADO ,'#13#10'       SUM(' +
      'CASE WHEN (rec.STATUS = '#39'7-'#39') THEN (REC.DESCONTO) ELSE REC.DESCO' +
      'NTO END) AS REEMBOLSO,'#13#10'    /*  SUM(ven.DESCONTO) as DESCONTOS*/' +
      #13#10'FROM RECEBIMENTO rec inner join CLIENTES cli on cli.CODCLIENTE' +
      '=rec.CODCLIENTE'#13#10'/*inner join VENDA ven on ven.NUMEROBORDERO = r' +
      'ec.CODRECEBIMENTO*/'#13#10
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.sqlsisAdimin
    Left = 328
    Top = 286
    object sds_totalRECEBIDO: TFloatField
      FieldName = 'RECEBIDO'
      ReadOnly = True
    end
    object sds_totalJUROS: TFloatField
      FieldName = 'JUROS'
      ReadOnly = True
    end
    object sds_totalPENDENTE: TFloatField
      FieldName = 'PENDENTE'
      ReadOnly = True
    end
    object sds_totalDUVIDOSO: TFloatField
      FieldName = 'DUVIDOSO'
      ReadOnly = True
    end
    object sds_totalTOTAL: TFloatField
      FieldName = 'TOTAL'
      ReadOnly = True
    end
    object sds_totalCANCELADO: TFloatField
      FieldName = 'CANCELADO'
      ReadOnly = True
    end
    object sds_totalREEMBOLSO: TFloatField
      FieldName = 'REEMBOLSO'
      ReadOnly = True
    end
    object sds_totalRECEBIDOS: TFloatField
      FieldName = 'RECEBIDOS'
      ReadOnly = True
    end
  end
  ...
  object PopupMenu1: TPopupMenu
    Left = 542
    Top = 248
    object BuscarClientes1: TMenuItem
  ...
  object sqlConferir: TSQLDataSet
    CommandText = 'select * from conferir (:assoc , :dta1 ,:dta2)'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object sds1: TSQLDataSet
    CommandText = 'select sum(preco) from conferir (:assoc , :dta1 ,:dta2)'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object SQLDataSet3: TSQLDataSet
    CommandText = 
      'SELECT sum(preco)as pagou , sum(reembolso)as reembolso FROM D_20' +
      '12 (:assoc , :dta1 ,:dta2)'
    MaxBlobSize = -1
    Params = <
      item
    ...
    Left = 640
    Top = 440
    object SQLDataSet3PAGOU: TFloatField
      FieldName = 'PAGOU'
      ReadOnly = True
    end
    object SQLDataSet3REEMBOLSO: TFloatField
      FieldName = 'REEMBOLSO'
      ReadOnly = True
    end
  end
  ...
  object cds2: TClientDataSet
    ...
    Left = 720
    Top = 440
    object cds2PAGOU: TFloatField
      FieldName = 'PAGOU'
      ReadOnly = True
    end
    object cds2REEMBOLSO: TFloatField
      FieldName = 'REEMBOLSO'
      ReadOnly = True
    end
  end
  object SQLDataSet4: TSQLDataSet
    CommandText = 
      'select '#13#10#13#10'    sum(valor_total) as valor_total ,'#13#10'    sum(valor_' +
      'total) + sum(valorr) as total,'#13#10'    sum(valorr)as valorr,'#13#10#13#10'   ' +
      ' sum(valor_recibo) as valor_recibo  '#13#10'  FROM REL_DMED_11(:titula' +
      'r) '
    MaxBlobSize = -1
    Params = <
      item
    ...
    object SQLDataSet4TOTAL: TFloatField
      FieldName = 'TOTAL'
      ReadOnly = True
    end
  ...
  object ClientDataSet2: TClientDataSet
    ...
    Left = 248
    Top = 320
    object ClientDataSet2VALOR_TOTAL: TFloatField
      FieldName = 'VALOR_TOTAL'
      ReadOnly = True
    end
    object ClientDataSet2TOTAL: TFloatField
      FieldName = 'TOTAL'
      ReadOnly = True
    end
    object ClientDataSet2VALORR: TFloatField
      FieldName = 'VALORR'
      ReadOnly = True
    end
    object ClientDataSet2VALOR_RECIBO: TFloatField
      FieldName = 'VALOR_RECIBO'
      ReadOnly = True
    end
  end
  object cds12: TClientDataSet
    ...
    Left = 184
    Top = 448
    object cds12CLI_CPF: TStringField
      FieldName = 'CLI_CPF'
      Size = 18
    end
    object cds12RA: TStringField
      FieldName = 'RA'
      Size = 10
    end
    object cds12RAZAOSOCIAL: TStringField
      FieldName = 'RAZAOSOCIAL'
      Size = 50
    end
  end
  ...
  object sql12: TSQLDataSet
    ...
    Left = 104
    Top = 448
    object sql12CLI_CPF: TStringField
      FieldName = 'CLI_CPF'
      Size = 18
    end
    object sql12RA: TStringField
      FieldName = 'RA'
      Size = 10
    end
    object sql12RAZAOSOCIAL: TStringField
      FieldName = 'RAZAOSOCIAL'
      Size = 50
    end
  end
  object sqlRa: TSQLDataSet
    CommandText = 'select * from D_2012 (:titular , :dta1 ,:dta2)'
    MaxBlobSize = -1
    Params = <
      item
    ...
    Left = 224
    Top = 440
    object sqlRaRA: TStringField
      FieldName = 'RA'
      Size = 10
    end
    object sqlRaRAZAOSOCIAL: TStringField
      FieldName = 'RAZAOSOCIAL'
      Size = 50
    end
    object sqlRaNOMECLIENTE: TStringField
      FieldName = 'NOMECLIENTE'
      Size = 50
    end
    object sqlRaCLI_CPF: TStringField
      FieldName = 'CLI_CPF'
      Size = 18
    end
    object sqlRaCONTROLE: TSmallintField
      FieldName = 'CONTROLE'
    end
  end
  object dspRa: TDataSetProvider
    DataSet = sqlRa
    Options = [poAllowCommandText]
    Left = 264
    Top = 440
  end
  object cdsRa: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftString
    ...
    Left = 304
    Top = 440
    object cdsRaRA: TStringField
      FieldName = 'RA'
      Size = 10
    end
    object cdsRaRAZAOSOCIAL: TStringField
      FieldName = 'RAZAOSOCIAL'
      Size = 50
    end
    object cdsRaNOMECLIENTE: TStringField
      FieldName = 'NOMECLIENTE'
      Size = 50
    end
    object cdsRaCLI_CPF: TStringField
      FieldName = 'CLI_CPF'
      Size = 18
    end
    object cdsRaCONTROLE: TSmallintField
      FieldName = 'CONTROLE'
    end
  end
  object sds_venda: TSQLDataSet
    CommandText = 
      'select sum( movd.PRECO)'#13#10#13#10'from MOVIMENTODETALHE movd '#13#10'inner jo' +
      'in PRODUTOS prod on prod.CODPRODUTO = movd.CODPRODUTO '#13#10'inner jo' +
      'in venda ven on ven.codmovimento = movd.codmovimento'#13#10'inner join' +
      ' clientes cli on cli.codcliente = movd.controle'#13#10#13#10'where (NUMERO' +
      'BORDERO = :CODVENDA)'
    MaxBlobSize = -1
    Params = <
      item
    ...
    Left = 7
    Top = 327
    object sds_vendaSUM: TFloatField
      FieldName = 'SUM'
      ReadOnly = True
    end
  end
