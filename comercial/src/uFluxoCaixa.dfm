object fFluxoCaixa: TfFluxoCaixa
  ...
  object sds: TSQLDataSet
    CommandText = 
      'SELECT * FROM FLUXOCAIXAVER('#39'02/01/08'#39', '#39'02/10/08'#39') order by tip' +
      'o'
    MaxBlobSize = -1
    Params = <>
  ...
  object cds: TClientDataSet
    ...
    object cdsNOMECONTA: TStringField
      FieldName = 'NOMECONTA'
      Size = 50
    end
    ...
    object cdsDIA1: TFloatField
      FieldName = 'DIA1'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA2: TFloatField
      FieldName = 'DIA2'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA3: TFloatField
      FieldName = 'DIA3'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA4: TFloatField
      FieldName = 'DIA4'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA5: TFloatField
      FieldName = 'DIA5'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA6: TFloatField
      FieldName = 'DIA6'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA7: TFloatField
      FieldName = 'DIA7'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA8: TFloatField
      FieldName = 'DIA8'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA9: TFloatField
      FieldName = 'DIA9'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA10: TFloatField
      FieldName = 'DIA10'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA11: TFloatField
      FieldName = 'DIA11'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA12: TFloatField
      FieldName = 'DIA12'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA13: TFloatField
      FieldName = 'DIA13'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA14: TFloatField
      FieldName = 'DIA14'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA15: TFloatField
      FieldName = 'DIA15'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA16: TFloatField
      FieldName = 'DIA16'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA17: TFloatField
      FieldName = 'DIA17'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA18: TFloatField
      FieldName = 'DIA18'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA19: TFloatField
      FieldName = 'DIA19'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA20: TFloatField
      FieldName = 'DIA20'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA21: TFloatField
      FieldName = 'DIA21'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA22: TFloatField
      FieldName = 'DIA22'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA23: TFloatField
      FieldName = 'DIA23'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA24: TFloatField
      FieldName = 'DIA24'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA25: TFloatField
      FieldName = 'DIA25'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA26: TFloatField
      FieldName = 'DIA26'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA27: TFloatField
      FieldName = 'DIA27'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA28: TFloatField
      FieldName = 'DIA28'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA29: TFloatField
      FieldName = 'DIA29'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA30: TFloatField
      FieldName = 'DIA30'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cdsDIA31: TFloatField
      FieldName = 'DIA31'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
