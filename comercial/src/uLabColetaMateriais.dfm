inherited fLabColetaMateriais: TfLabColetaMateriais
  Left = 369
  Top = 133
  Width = 733
  Height = 437
  ...
  inherited MMJPanel2: TMMJPanel
    ...
    inherited btnProcurar: TBitBtn [4]
      Visible = False
    end
    inherited btnSair: TBitBtn [5]
      Left = 485
    end
    object dt1: TJvDatePickerEdit [6]
      Left = 95
      Top = 22
      Width = 102
      Height = 21
