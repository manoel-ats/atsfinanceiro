  ...
  ////     DMSaude.cdsGuiasCKA35.AsString     := 'S';
   ...
   // if(DBEdit119.Text <> '')then
    ...
    begin
     ...
     // DMSaude.cdsGuiasCKA30.AsString      := 'S'; // := DBEdit134.Text;   23/06/20
...
begin
 ...
 /////DtSrc.DataSet.Cancel;
  ...
  DMSaude.dsGuias.DataSet.Cancel;
end;
...
begin
      ...
      if(cdsBuscaGuiaCKAOM.AsString = 'S' )then
...
begin
 // inherited;
      ...
      begin
        ...
        ', TIPO_GUIA = ' + QuotedStr(fPlanoSaude.UserControlSaude.CurrentUser.UserName)  +
        ' WHERE ID_GUIAS  = ' + IntToStr(cdsBuscaGuiaID_GUIAS.AsInteger) ;
