object DM: TDM
  ...
  object s_4: TSQLDataSet
    ...
    object s_4DATAINCLUSAO: TDateField
      FieldName = 'DATAINCLUSAO'
    end
    object s_4CODCLIENTE: TIntegerField
      FieldName = 'CODCLIENTE'
    end
    object s_4DATAPROCEDIMENTO: TDateField
      FieldName = 'DATAPROCEDIMENTO'
    end
  end
  ...
  object cds_4_pagar: TClientDataSet
    ...
    object cds_4_pagarDATAINCLUSAO: TDateField
      FieldName = 'DATAINCLUSAO'
      EditMask = '!99/99/00;1;_'
    end
    object cds_4_pagarCODCLIENTE: TIntegerField
      FieldName = 'CODCLIENTE'
    end
    object cds_4_pagarDATAPROCEDIMENTO: TDateField
      FieldName = 'DATAPROCEDIMENTO'
  ...
  object s3_contabil: TSQLDataSet
    CommandText = 
      'select mov.*, HC.HISTORICO, plano.NOME, plano.CODREDUZIDO  from ' +
      #13#10'MOVIMENTOCONT mov'#13#10'INNER JOIN HISTORICO_CONTAB HC ON HC.COD_CO' +
      'NTAB = MOV.CODORIGEM '#13#10'LEFT OUTER JOIN PLANO on PLANO.CONTA = mo' +
      'v.CONTA '#13#10'where mov.CODORIGEM = :PCOD AND mov.TIPOORIGEM = :PTIP' +
      'O'
    MaxBlobSize = -1
    Params = <
      item
    ...
    object s3_contabilHISTORICO: TStringField
      FieldName = 'HISTORICO'
      ProviderFlags = [pfInUpdate]
      Required = True
      Size = 200
  ...
  object c3_contabil: TClientDataSet
    ...
    object c3_contabilHISTORICO: TStringField
      FieldName = 'HISTORICO'
  ...
  object sqlConta: TSQLDataSet
    CommandText = 'select * from PLANO where contapai = '#39'1.1.1.01'#39' order by CONTA'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = sqlsisAdimin
    Left = 912
    Top = 8
    object sqlContaCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Required = True
    end
    object sqlContaCONTA: TStringField
      FieldName = 'CONTA'
      Required = True
      Size = 15
    end
    object sqlContaCONTAPAI: TStringField
      FieldName = 'CONTAPAI'
      Size = 10
    end
    ...
    object sqlContaCONSOLIDA: TStringField
      FieldName = 'CONSOLIDA'
      FixedChar = True
      Size = 1
    end
    object sqlContaDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 50
    end
    object sqlContaRATEIO: TStringField
      FieldName = 'RATEIO'
      FixedChar = True
      Size = 1
    end
    object sqlContaCODREDUZIDO: TStringField
      FieldName = 'CODREDUZIDO'
      Size = 15
    end
  end
  ...
  object cdsConta: TClientDataSet
    ...
    object cdsContaCONTA: TStringField
      FieldName = 'CONTA'
      Required = True
      Size = 15
    end
    object cdsContaCONTAPAI: TStringField
      FieldName = 'CONTAPAI'
      Size = 10
    end
    ...
    object cdsContaCONSOLIDA: TStringField
      FieldName = 'CONSOLIDA'
      FixedChar = True
      Size = 1
    end
    ...
    object cdsContaRATEIO: TStringField
      FieldName = 'RATEIO'
      FixedChar = True
      Size = 1
    end
    object cdsContaCODREDUZIDO: TStringField
      FieldName = 'CODREDUZIDO'
      Size = 15
    end
  end
