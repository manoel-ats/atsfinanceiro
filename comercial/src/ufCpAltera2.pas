...
procedure TfCpAltera2.BitBtn1Click(Sender: TObject);
begin
  inherited;
  btnGravar.Click;
end;

procedure TfCpAltera2.btnGravarClick(Sender: TObject);
var
  utilcrtitulo : Tutils;
...
procedure TfCpAltera2.FormCreate(Sender: TObject);
...
procedure TfCpAltera2.FormShow(Sender: TObject);

var utilcrtitulo : Tutils;
  i, j : integer;
begin
   // inherited;
   sCtrlResize.CtrlResize(TForm(fCpAltera2));
