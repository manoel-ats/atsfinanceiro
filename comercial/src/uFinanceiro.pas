...
uses
  ...
  Dialogs, ComCtrls, Menus, FMTBcd, ExtCtrls, StdCtrls, DBClient,
...
type
  TfFinanceiro = class(TForm)
    ...
    GerarDados1: TMenuItem;
    ConferirMensalidades1: TMenuItem;
    conf21: TMenuItem;
    BitBtn1: TBitBtn;
    ...
    ConferirMensalidadeGErada1: TMenuItem;
    ...
    procedure GerarDados1Click(Sender: TObject);
    procedure ConferirMensalidades1Click(Sender: TObject);
    procedure conf21Click(Sender: TObject);
    procedure BitBtn1Click(Sender: TObject);
    procedure Relatorios1Click(Sender: TObject);
    procedure Cobranas1Click(Sender: TObject);
    procedure Compras1Click(Sender: TObject);
    procedure RelatorioDMEDRECIBO1Click(Sender: TObject);
    procedure FechamentoCaixa1Click(Sender: TObject);
    procedure ConferirMensalidadeGErada1Click(Sender: TObject);
    procedure SpeedButton12Click(Sender: TObject);
    procedure Previso1Click(Sender: TObject);
  private
...
begin
  ...
  Label2.Caption := ' ATS - Financeiro - ASH  versão: ' + GetVersion;
...
begin
  ...
  begin
    ...
    try
      ...
      fLancaProcSaudeProc.btnPDF.Visible := True;
      fLancaProcSaudeProc.btnfichaPdf.Visible := False;
      fLancaProcSaudeProc.BitBtn14.Visible := True;

      fLancaProcSaudeProc.BitBtn15.Visible := True;
      fLancaProcSaudeProc.RadioGroup1.Visible := True;
      fLancaProcSaudeProc.entrada1.Visible := True;
      fLancaProcSaudeProc.entrada2.Visible := True;
      fLancaProcSaudeProc.Label18.Visible := True;
      fLancaProcSaudeProc.Label17.Visible := True;
      fLancaProcSaudeProc.BitBtn16.Visible := False;
      fLancaProcSaudeProc.ckCorrigir.Visible := True;
      fLancaProcSaudeProc.Label19.Visible := True;
...
begin
  ...
  begin
    ...
    try
      ...
      fLancaProcSaudeProc.btnPDF.Visible := False;
      fLancaProcSaudeProc.btnfichaPdf.Visible := True;
      fLancaProcSaudeProc.BitBtn14.Visible := False;

      fLancaProcSaudeProc.BitBtn15.Visible := False;
      fLancaProcSaudeProc.RadioGroup1.Visible := False;
      fLancaProcSaudeProc.entrada1.Visible := False;
      fLancaProcSaudeProc.entrada2.Visible := False;
      fLancaProcSaudeProc.Label18.Visible := False;
      fLancaProcSaudeProc.Label17.Visible := False;
      fLancaProcSaudeProc.BitBtn16.Visible := False;
      fLancaProcSaudeProc.ckCorrigir.Visible := True;
      fLancaProcSaudeProc.Label19.Visible := False;
...
begin
  ...
  begin
    ...
    try
      ...
      fLancaProcSaudeProc.Label18.Visible := False;
      fLancaProcSaudeProc.Label17.Visible := False;
      fLancaProcSaudeProc.BitBtn16.Visible := True;
    //  fLancaProcSaudeProc.BitBtn5.Visible:= False;
    //  fLancaProcSaudeProc.btnfichaPdf.Visible := False;
    //  fLancaProcSaudeProc.BitBtn10.Visible := False;
      fLancaProcSaudeProc.ShowModal;
...
procedure TfFinanceiro.ArquivoRetorno1Click(Sender: TObject);
begin
  fArquivoRetorno := TfArquivoRetorno.Create(Application);
...
procedure TfFinanceiro.GerarDados1Click(Sender: TObject);
begin
...
procedure TfFinanceiro.ConferirMensalidades1Click(Sender: TObject);
begin
  fConf := TfConf.Create(Application);
  try
    fConf.ShowModal;
  finally
    fConf.Free;
...
procedure TfFinanceiro.conf21Click(Sender: TObject);
begin
  fConf2 := TfConf2.Create(Application);
  try
    fConf2.ShowModal;
  finally
    fConf2.Free;
...
procedure TfFinanceiro.BitBtn1Click(Sender: TObject);
begin
...
procedure TfFinanceiro.Relatorios1Click(Sender: TObject);
begin
  fCpProcS:=TfCpProcS.Create(Application);
  fCpProcS.btnIncluir.Enabled := False;
  fCpProcS.bitBtn9.Enabled := True;
  try
    fcpprocS.ShowModal;
  finally
   fcpprocS.free;
...
procedure TfFinanceiro.Cobranas1Click(Sender: TObject);
begin
...
procedure TfFinanceiro.Compras1Click(Sender: TObject);
begin
...
procedure TfFinanceiro.RelatorioDMEDRECIBO1Click(Sender: TObject);
begin
{  fRelDMED := TfRelDMED.Create(Application);
  try
    fRelDMED.ShowModal;
  finally
    fRelDMED.Free;
...
procedure TfFinanceiro.FechamentoCaixa1Click(Sender: TObject);
begin
  fFechamento_caixa := TfFechamento_caixa.Create(Application);
  try
    fFechamento_caixa.ShowModal;
  finally
    fFechamento_caixa.Free;
  end;
end;

procedure TfFinanceiro.ConferirMensalidadeGErada1Click(Sender: TObject);
begin
  fConMens := TfConMens.Create(Application);
  try
    fConMens.ShowModal;
  finally
    fConMens.Free;
...
procedure TfFinanceiro.SpeedButton12Click(Sender: TObject);
begin

  fLancaProcSaudeExames := TfLancaProcSaudeExames.Create(Application);
  try
     fLancaProcSaudeExames.ShowModal;
  finally
    fLancaProcSaudeExames.Free;
  end;

end;

procedure TfFinanceiro.Previso1Click(Sender: TObject);
begin
  fFamiliaP := TfFamiliaP.Create(Application);
  try
    fFamiliaP.ShowModal;
  finally
    fFamiliaP.Free;
