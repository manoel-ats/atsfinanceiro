inherited fNotaFiscalExporta: TfNotaFiscalExporta
  ...
  object sdsNF: TSQLDataSet
    CommandText = 
      ...
      'or_produto, nf.valor_total_nota, cli.nomecliente, mnf.PRECOEXP, ' +
      'mnf.QTDEEXP '#13#10', prod.PRODUTO, prod.CODPRO, mnf.QUANTIDADE, mnf.P' +
      'RECO , nf.VLRTOTALEXP, nf.NOTASERIE'#13#10'from notafiscal nf '#13#10'left o' +
      'uter join clientes cli on cli.codcliente = nf.codcliente'#13#10'inner ' +
      'join movimentonf mnf on mnf.codMovimento = nf.NUMNF '#13#10'inner join' +
      ' produtos prod on prod.codproduto = mnf.codproduto'#13#10' where '#13#10'nf.' +
      'dtaemissao between :pdta1 and :pdta2 and ((nf.status = :pstatus)' +
      ' OR '#13#10'(:pstatus = '#39'0'#39')) and ((nf.NATUREZA = :pNat) OR (:pNat = 0' +
      '))'
    MaxBlobSize = -1
    Params = <
      item
