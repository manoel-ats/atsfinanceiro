object fProcura_prod: TfProcura_prod
  ...
  object sds_proc: TSQLDataSet
    CommandText = 
      ...
      'o.PESO_QTDE, pro.IPI ,pro.PEDIDO'#13#10'from LISTAPRODUTO pro '#13#10'left o' +
      'uter join CODIGOS cod on cod.COD_PRODUTO = pro.CODPRODUTO '#13#10'left' +
      ' outer join USO_PRODUTO uso on uso.COD_PRODUTO = pro.CODPRODUTO'
    MaxBlobSize = -1
    Params = <>
