object fLancaProcSaudeProc: TfLancaProcSaudeProc
  ...
  object dsAviso: TClientDataSet
    ...
    Left = 432
    Top = 392
    object dsAvisoCODCLI: TIntegerField
      FieldName = 'CODCLI'
    end
  end
  object sAviso: TSQLDataSet
    CommandText = 
      'SELECT codcli  FROM AVISO_ASH('#39'06/01/11'#39','#39'06/24/11'#39','#39'07/08/11'#39','#39 +
      '07/08/11'#39',0,0,0,0,51)'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.sqlsisAdimin
    Left = 328
    Top = 392
    object sAvisoCODCLI: TIntegerField
      FieldName = 'CODCLI'
    end
  end
  object dAviso: TDataSetProvider
    DataSet = sAviso
    Left = 376
    Top = 400
  end
