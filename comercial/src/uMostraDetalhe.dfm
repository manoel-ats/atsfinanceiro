object fMostraDetalhe: TfMostraDetalhe
  ...
  object sds_Mov_Det: TSQLDataSet
    CommandText = 
      ...
      'umerobordero'#13#10', ven.codvenda'#13#10', ven.datavenda'#13#10', ven.datavencime' +
      'nto'#13#10', cli.nomecliente  '#13#10#13#10'from MOVIMENTODETALHE movd '#13#10'inner j' +
      'oin PRODUTOS prod on prod.CODPRODUTO = movd.CODPRODUTO '#13#10'inner j' +
      'oin venda ven on ven.codmovimento = movd.codmovimento'#13#10'inner joi' +
      'n clientes cli on cli.codcliente = movd.controle'#13#10#13#10'where (NUMER' +
      'OBORDERO = :CODVENDA)'
    MaxBlobSize = -1
    Params = <
      item
    ...
    object sds_Mov_DetDATAVENDA: TDateField
      FieldName = 'DATAVENDA'
      Required = True
    end
    object sds_Mov_DetDATAVENCIMENTO: TDateField
      FieldName = 'DATAVENCIMENTO'
      Required = True
    end
  end
  ...
  object cds_Mov_det: TClientDataSet
    ...
    object cds_Mov_detDATAVENDA: TDateField
      FieldName = 'DATAVENDA'
      Required = True
    end
    object cds_Mov_detDATAVENCIMENTO: TDateField
      FieldName = 'DATAVENCIMENTO'
      Required = True
    end
  end
  ...
  object sds: TSQLDataSet
    CommandText = 
      'select rec.TITULO, rec.EMISSAO, rec.JUROS , '#13#10'    rec.DATAVENCIM' +
      'ENTO, rec.VALORTITULO, '#13#10'    rec.STATUS '#13#10'    from RECEBIMENTO r' +
      'ec'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.sqlsisAdimin
