...
begin
  ...
  begin
   ...
   try
    ...
    edt1.Text := IntToStr(fListaClienteSaude.cdsCODCLIENTE.AsInteger);
...
begin
  try
    ...
    VCLContas_pendente.Report.Params.ParamByName('PCLI').Value := edt1.Text;
    ...
    if edCodCliente.Text <> '' then
      VCLContas_pendente.Report.Params.ParamByName('PCLI').Value := strToInt(edt1.Text)
    else
...
begin
  ...
  if(DMSaude.cdsCliente.Active) then
    ...
    DMSaude.cdsCliente.Params[0].AsInteger := StrToInt(edt1.Text);
   ...
   dm.scds_cliente_proc.Params[2].AsInteger := StrToInt(edt1.Text);
