...
uses UDm, uCheques_bol, uUtils, sCtrlResize, uFinanceiro;
...
begin
  ...
  if(dm.cds_4_pagarCODALMOXARIFADO.AsInteger = 52) then
  begin
    if((Edit1.Text = 'ANA PAULA') OR (Edit1.Text = 'RENATA') OR (Edit1.Text = 'elis') )then
    begin
      aut := 1 ;
///
...
///
  ...
  if(dm.cds_4_pagarCODALMOXARIFADO.AsInteger = 51) then
  begin
...
begin
  ...
  Try
    ...
    str_sql := str_sql + ', DATAPAGAMENTO = null WHERE CODFORNECEDOR = ';
    str_sql := str_sql + IntToStr(dm.cds_4_pagarCODFORNECEDOR.AsInteger);
...
procedure TfcpTitulo.btnCancelarClick(Sender: TObject);
var aut : integer ;
begin
 // inherited;
...
procedure TfcpTitulo.btnExcluirClick(Sender: TObject);
var aut : integer ;
begin
//  inherited;
 if((Edit1.Text = 'RENATA') or (Edit1.Text = 'ANA PAULA') or (Edit1.Text = 'elis') or (Edit1.Text = 'adm'))then
