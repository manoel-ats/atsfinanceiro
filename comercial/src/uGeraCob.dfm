object fGeraCob: TfGeraCob
  ...
  object Label4: TLabel
    ...
    Width = 276
    Height = 16
    Caption = 'Emiss'#227'o Sempre o ULTIMO dia do MES'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
  ...
  object rd: TCheckBox
    ...
    Width = 185
    Height = 17
    Caption = 'Primeira Mensalidade do Ano'
    TabOrder = 11
  end
  ...
  object sqlValor: TSQLDataSet
    CommandText = 'select  count(VALOR) from HIST_FAIXA where valor is null'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.sqlsisAdimin
    Left = 344
    Top = 256
    object sqlValorVALOR: TFloatField
      FieldName = 'VALOR'
    end
  end
end
