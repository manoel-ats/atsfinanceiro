object fcrProcSaude: TfcrProcSaude
  ...
  object sds: TSQLDataSet
    CommandText = 
      ...
      '    , rec.VALORRECEBIDO'#13#10'        , rec.juros'#13#10'        , UDF_PADL' +
      '(CAST(UDF_TRIM(rec.VIA) AS VARCHAR(2)),'#39'0'#39',2) || '#39'/'#39' || CAST(UDF' +
      '_PADL(rec.PARCELAS,'#39'0'#39',2) as varchar(2)) as VIA  '#13#10'        , rec' +
      '.HISTORICO '#13#10'        , rec.N_DOCUMENTO'#13#10'        , rec.DUP_REC_NF' +
      #13#10'        , rec.DP'#13#10'        , rec.CODVENDA'#13#10'        , cli.NOMECL' +
      'IENTE'#13#10'        , cli.RAZAOSOCIAL'#13#10'        , cli.RA'#13#10'        , (r' +
      'ec.VALORTITULO - rec.VALOR_RESTO) as VALORREC '#13#10' from RECEBIMENT' +
      'O rec '#13#10' inner join CLIENTES cli on cli.CODCLIENTE=rec.CODCLIENT' +
      'E '
    MaxBlobSize = -1
    Params = <>
