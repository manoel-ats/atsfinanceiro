...
begin
  ...
  DecodeDate(meDta4.Date , Ano, Mes, Dia);
  if(mes <> 1) then
  mes := mes - 1;
  dia := 15 ;
  ...
  Try
    ...
    '''' + formatdatetime('mm/dd/yy', StrToDateTime(data)) + '''' +
   ...
   begin
     ...
     //    ShowMessage('Classe: ' + e.ClassName + chr(13) + 'Mensagem: ' + e.Message);
         ...
         Memo1.Lines.Add('Classe: ' + e.ClassName + chr(13) + 'Mensagem: ' + e.Message);
       end;
     end;
     cds_cli_1.Next;
     FlatGauge1.Progress := FlatGauge1.Progress + 1;
...
procedure TfGeraCob.FormShow(Sender: TObject);
begin
