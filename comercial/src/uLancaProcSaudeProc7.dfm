object fLancaProcSaudeProc: TfLancaProcSaudeProc
  ...
  object dtnewrec: TJvDatePickerEdit
    Left = 264
    Top = 492
    Width = 85
    Height = 21
  ...
  object sSoma: TSQLClientDataSet
    Aggregates = <>
    Options = [poAllowCommandText]
    ObjectView = True
    Params = <>
  ...
  object sqlN: TSQLDataSet
    CommandText = 
      'select  CODVENDA,CODMOVIMENTO, CODCLIENTE,DATAVENDA , DATAVENCIM' +
      'ENTO , NUMEROBORDERO ,'#13#10'            VALOR, NOTAFISCAL, SERIE, DE' +
      'SCONTO , CODCCUSTO, N_PARCELA,MULTA_JUROS, ENTRADA'#13#10'      from v' +
      'enda'#13#10'where CODVENDA = :codvenda'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    Left = 112
    Top = 408
    object sqlNCODVENDA: TIntegerField
      FieldName = 'CODVENDA'
      Required = True
    end
    object sqlNCODMOVIMENTO: TIntegerField
      FieldName = 'CODMOVIMENTO'
      Required = True
    end
    object sqlNCODCLIENTE: TIntegerField
      FieldName = 'CODCLIENTE'
      Required = True
    end
    object sqlNDATAVENDA: TDateField
      FieldName = 'DATAVENDA'
      Required = True
    end
    object sqlNDATAVENCIMENTO: TDateField
      FieldName = 'DATAVENCIMENTO'
      Required = True
    end
    object sqlNNUMEROBORDERO: TIntegerField
      FieldName = 'NUMEROBORDERO'
    end
    object sqlNVALOR: TFloatField
      FieldName = 'VALOR'
    end
    object sqlNNOTAFISCAL: TIntegerField
      FieldName = 'NOTAFISCAL'
    end
    object sqlNSERIE: TStringField
      FieldName = 'SERIE'
    end
    object sqlNDESCONTO: TFloatField
      FieldName = 'DESCONTO'
    end
    object sqlNCODCCUSTO: TSmallintField
      FieldName = 'CODCCUSTO'
    end
    object sqlNN_PARCELA: TSmallintField
      FieldName = 'N_PARCELA'
    end
    object sqlNMULTA_JUROS: TFloatField
      FieldName = 'MULTA_JUROS'
    end
    object sqlNENTRADA: TFloatField
      FieldName = 'ENTRADA'
    end
  end
  object dspN: TDataSetProvider
    DataSet = sqlN
    Left = 144
    Top = 408
  end
  object dsN: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    Left = 184
    Top = 408
    object dsNCODVENDA: TIntegerField
      FieldName = 'CODVENDA'
      Required = True
    end
    object dsNCODMOVIMENTO: TIntegerField
      FieldName = 'CODMOVIMENTO'
      Required = True
    end
    object dsNCODCLIENTE: TIntegerField
      FieldName = 'CODCLIENTE'
      Required = True
    end
    object dsNDATAVENDA: TDateField
      FieldName = 'DATAVENDA'
      Required = True
    end
    object dsNDATAVENCIMENTO: TDateField
      FieldName = 'DATAVENCIMENTO'
      Required = True
    end
    object dsNNUMEROBORDERO: TIntegerField
      FieldName = 'NUMEROBORDERO'
    end
    object dsNVALOR: TFloatField
      FieldName = 'VALOR'
    end
    object dsNNOTAFISCAL: TIntegerField
      FieldName = 'NOTAFISCAL'
    end
    object dsNSERIE: TStringField
      FieldName = 'SERIE'
    end
    object dsNDESCONTO: TFloatField
      FieldName = 'DESCONTO'
    end
    object dsNCODCCUSTO: TSmallintField
      FieldName = 'CODCCUSTO'
    end
    object dsNN_PARCELA: TSmallintField
      FieldName = 'N_PARCELA'
    end
    object dsNMULTA_JUROS: TFloatField
      FieldName = 'MULTA_JUROS'
    end
    object dsNENTRADA: TFloatField
      FieldName = 'ENTRADA'
    end
  end
end
