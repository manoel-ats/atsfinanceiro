inherited fCompraFinalizar: TfCompraFinalizar
  ...
  object sds_compra: TSQLDataSet
    ...
    object sds_compraDATAINCLUSAO: TDateField
      FieldName = 'DATAINCLUSAO'
    end
    object sds_compraDATACONSOLIDA: TDateField
  ...
  object cds_compra: TClientDataSet
    ...
    object cds_compraDATAINCLUSAO: TDateField
      FieldName = 'DATAINCLUSAO'
      EditMask = '!99/99/00;1;_'
    end
    object cds_compraDATACONSOLIDA: TDateField
      FieldName = 'DATACONSOLIDA'
      EditMask = '!99/99/00;1;_'
    end
  end
  ...
  object sqlSoma: TSQLDataSet
    CommandText = 
      'select sum (valortitulo) ,valortitulo from PAGAMENTO pag '#13#10'where' +
      ' CODCOMPRA=:pcod'#13#10'group by valortitulo'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
