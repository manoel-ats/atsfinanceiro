inherited fProcuraCheque: TfProcuraCheque
  ...
  object sCP: TSQLDataSet
    CommandText = 
      'select rec.dp, rec.dup_rec_nf,  '#13#10'            rec.DATACONSOLIDA,' +
      ...
      'MENTO, '#13#10'            rec.dp, rec.dup_rec_nf,plano.NOME, rec.CAIX' +
      'A'
    MaxBlobSize = -1
    Params = <>
    ...
    object sCPDUP_REC_NF: TStringField
      FieldName = 'DUP_REC_NF'
      Size = 15
    end
  ...
  object scdsCr_proc: TClientDataSet
    ...
    object scdsCr_procFORMAPGTO: TStringField
      FieldName = 'FORMAPGTO'
      ProviderFlags = []
      ReadOnly = True
      FixedChar = True
    ...
    object scdsCr_procSITUACAOCHEQUE: TStringField
      FieldName = 'SITUACAOCHEQUE'
      ProviderFlags = [pfInUpdate]
      Size = 10
    end
