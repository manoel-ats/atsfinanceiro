object fcrEscolas: TfcrEscolas
  ...
  object edCodCliente: TJvDBSearchEdit
    Left = 2
    Top = 117
    Width = 75
    Height = 24
  ...
  object scdsCr_proc: TClientDataSet
    ...
    object scdsCr_procSERIE: TStringField
      FieldName = 'SERIE'
      ReadOnly = True
      Size = 4
    end
    ...
    object scdsCr_procSERIELETRA: TStringField
    ...
    object scdsCr_procCURSO: TStringField
      FieldName = 'CURSO'
      ReadOnly = True
      Size = 50
    end
    object scdsCr_procATIVO: TSmallintField
      FieldName = 'ATIVO'
      ReadOnly = True
      Required = True
    end
  ...
  object sds: TSQLDataSet
    CommandText = 
      ...
      '     , cli.CURSO'#13#10'        , cli.STATUS as ATIVO '#13#10'        , rec.' +
      'PARCELAS'#13#10'        , (rec.VALORTITULO - rec.VALOR_RESTO) as VALOR' +
      'REC '#13#10' from RECEBIMENTO rec '#13#10' inner join CLIENTES cli on cli.CO' +
    ...
    object sdsCURSO: TStringField
      FieldName = 'CURSO'
      ReadOnly = True
      Size = 50
    end
    object sdsATIVO: TSmallintField
      FieldName = 'ATIVO'
      ReadOnly = True
      Required = True
    end
  ...
  object cds_total: TClientDataSet
    ...
    object cds_totalRESTO: TFloatField
      FieldName = 'RESTO'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
    object cds_totalVLT: TFloatField
      FieldName = 'VLT'
      DisplayFormat = ',##0.00'
      EditFormat = ',##0.00'
    end
  ...
  object sds_total: TSQLDataSet
    ...
    object sds_totalRESTO: TFloatField
      FieldName = 'RESTO'
    end
    object sds_totalVLT: TFloatField
      FieldName = 'VLT'
    end
  end
  ...
  object VCLReport1: TVCLReport
    Filename = 'C:\home\sisAdmin\relatorio\recibo.rep'
    AsyncExecution = False
    Title = 'Untitled'
    Left = 8
    Top = 440
