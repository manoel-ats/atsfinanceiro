...
type
  TDM = class(TDataModule)
    ...
    s_4DATAINCLUSAO: TDateField;
    cds_4_pagarDATAINCLUSAO: TDateField;
    s_4CODCLIENTE: TIntegerField;
    cds_4_pagarCODCLIENTE: TIntegerField;
    s_4DATAPROCEDIMENTO: TDateField;
    cds_4_pagarDATAPROCEDIMENTO: TDateField;
    s3_contabilHISTORICO: TStringField;
    c3_contabilHISTORICO: TStringField;
    ...
    sqlContaCODIGO: TIntegerField;
    sqlContaCONTA: TStringField;
    sqlContaCONTAPAI: TStringField;
    sqlContaNOME: TStringField;
    sqlContaCONSOLIDA: TStringField;
    sqlContaDESCRICAO: TStringField;
    sqlContaRATEIO: TStringField;
    sqlContaCODREDUZIDO: TStringField;
    cdsContaCODIGO: TIntegerField;
    cdsContaCONTA: TStringField;
    cdsContaCONTAPAI: TStringField;
    cdsContaNOME: TStringField;
    cdsContaCONSOLIDA: TStringField;
    cdsContaDESCRICAO: TStringField;
    cdsContaRATEIO: TStringField;
    cdsContaCODREDUZIDO: TStringField;
  ...
  public
    ...
    varCodTransp, codcli, codVendedor, varUSERID, varStatusCaixa : integer;
    varDataCaixa : TDateTime;
    varNomeCliente, varFormemUso : string;
...
var
  ...
  usuario, varform, nome_user, str_relatorio, relPersonalizado, perfil, varusuario : String;
