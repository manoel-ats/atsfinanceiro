...
begin
 ...
 MaskEdit1.Color := clYellow;
  ...
  VCLReport1.Filename := str_relatorio + 'ash_MensalidadeLista1.rep';
  ...
  VCLReport1.Title := str_relatorio + 'ash_MensalidadeLista1.rep';
  VCLReport1.Execute;
  ...
  // Caixa
  if ((edCodCCusto.Text <> '') or (edCodCCusto.Text <> 'PARTICULAR')) then
  begin
    if (not dm.cds_ccusto.Active) then
       dm.cds_ccusto.Open;
    dm.cds_ccusto.Locate('NOME', edCodCCusto.Text,[loPartialKey]);
    ...
    VCLReport1.Report.Params.ParamByName('PCCUSTO').Value := '0';
  VCLReport1.Title := str_relatorio + 'ash_MensalidadeLista.rep';
  VCLReport1.Execute;
  VCLReport1.Report.DatabaseInfo.Items[0].DisConnect;
...
begin
  ...
  VCLReport1.Filename := str_relatorio + 'ash_MensalidadeLista_atrazada1.rep';
  VCLReport1.Report.DatabaseInfo.Items[0].SQLConnection := dm.sqlsisAdimin;
  ...
  begin
    ...
    VCLReport1.Report.Params.ParamByName('PCCUSTO').Value := '0';
  VCLReport1.Title := str_relatorio + 'ash_MensalidadeLista_atrazada1.rep';
  VCLReport1.Execute;
  VCLReport1.Report.DatabaseInfo.Items[0].DisConnect;
  end;
  ...
  begin
    ...
    VCLReport1.Report.Params.ParamByName('PCCUSTO').Value := '0';
  VCLReport1.Title := str_relatorio + 'ash_MensalidadeLista_atrazada.rep';
  VCLReport1.Execute;
  VCLReport1.Report.DatabaseInfo.Items[0].DisConnect;
  end;
...
procedure TfRelatorioAsh.BitBtn6Click(Sender: TObject);
var data1,data2 :TRpLabel;
begin
  MaskEdit1.Color := clYellow;
  MaskEdit2.Color := clYellow;
  ...
  VCLReport1.Filename := str_relatorio + 'ash_MensalidadeListaRee.rep';
  VCLReport1.Report.DatabaseInfo.Items[0].SQLConnection := dm.sqlsisAdimin;
...
procedure TfRelatorioAsh.BitBtn7Click(Sender: TObject);
var data1,data2 :TRpLabel;
begin
 ...
 MaskEdit1.Color := clYellow;
  ...
  VCLReport1.Filename := str_relatorio + 'ash_MensalidadeListaMensalidade.rep';
  VCLReport1.Report.DatabaseInfo.Items[0].SQLConnection := dm.sqlsisAdimin;
  ...
  begin
    ...
    VCLReport1.Report.Params.ParamByName('PCCUSTO').Value := '0';
  VCLReport1.Title := str_relatorio + 'ash_MensalidadeListaMensalidade.rep';
  VCLReport1.Execute;
  VCLReport1.Report.DatabaseInfo.Items[0].DisConnect;
