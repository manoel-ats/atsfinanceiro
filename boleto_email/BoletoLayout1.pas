...
uses
  ...
  Dialogs, RLReport, ImgList , RLSaveDialog, RLFilters, RLPDFFilter, jpeg, StdCtrls
 {$IFDEF VER150}
   ,Variants
 {$ELSE}
  {$IFDEF VER140}
    ,Variants, RLSaveDialog, RLFilters, RLPDFFilter, jpeg, StdCtrls,
  Buttons
  {$ENDIF}
 {$ENDIF}
  ;
