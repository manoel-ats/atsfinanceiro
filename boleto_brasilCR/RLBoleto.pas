...
uses
   ...
   BoletoLayout, Controls, Forms ,RLPDFFilter
  {$IFDEF VER150}
...
begin
  ...
  ///  txtNomeSacado1.Caption := AnsiUpperCase(Sacado.Nome);
    ...
    txtNossoNumero2.Caption := '3002206' + ANossoNumero;
   ...
   // txtSacadorAvalista2.Caption := AnsiUpperCase(Sacado.SacadorAvaLista);
    txtCodigoBaixa2.Caption := '3002206'+ ANossoNumero;
    ...
    txtNossoNumero3.Caption := '3002206' + ANossoNumero;
   ...
   // txtSacadorAvalista3.Caption := AnsiUpperCase(Sacado.SacadorAvaLista);
    txtCodigoBaixa3.Caption := '3002206' + ANossoNumero;
    txtLinhaDigitavel.Caption := CodigoBarra.LinhaDigitavel;
    txtLinhaDigitavel1.Caption := CodigoBarra.LinhaDigitavel;
...
begin
  ...
  try 
   ...
   // FilterPDF.FilterPages(ABoleto.LayoutBoleto.Pages);  04/01/2018 comentado
    ABoleto.Free;
    FilterPDF.Free;
  except 
    ABoleto.Free; 
