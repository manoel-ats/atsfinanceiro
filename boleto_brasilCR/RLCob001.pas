...
begin
   ...
   begin
      ...
      Registro := Registro + '003002206'; //Formatar(Titulos[NumeroRegistro].Cedente.CoodigoCedente,9,false,'0'); //33 a 52 - Código do convênio no banco
      Registro := Registro + '0014';
      Registro := Registro + '17019';
      Registro := Registro + '  ';
      ...
      begin
         ...
         Registro := Registro + '3002206';
         Registro := Registro + Formatar(Titulos[NumeroRegistro].NossoNumero,10,false,'0'); //37 a 57 - Nosso número - identificação do título no banco
         Registro := Registro + '   ';
        // Registro := Registro + Formatar(Titulos[NumeroRegistro].NossoNumero,13,true,'0');
       //  Registro := Registro + 'X';
         ...
         Registro := Registro + Formatar(Titulos[NumeroRegistro].NossoNumero,7,false,'0'); //63 a 77 - Número que identifica o título na empresa
         Registro := Registro + '        ';
         ...
         begin
            Registro := Registro + '1'; //118 - Código de juros de mora  (não há juros)
            Registro := Registro + Formatar('',8,false,'0'); //119 a 126 - Data a partir da qual serão cobrados juros
