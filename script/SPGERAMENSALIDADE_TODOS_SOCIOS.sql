...
begin
       ...
       Select  ven.codVenda from Venda ven, MovimentoDetalhe movd where movd.codMovimento = ven.codMovimento and
         codCliente = :CODIGO and((movd.codProduto = 744)or(movd.codProduto = 745 ))and ven.DATAVENCIMENTO = :vencimento
       into :V;
       if (V is null) then
      begin
    ...
    */
    ...
    do begin
      ...
      begin
       ...
       /* Verifico se não foi lançado mensalidade neste vencimento */
       Select ven.codVenda from Venda ven, MovimentoDetalhe movd where movd.codMovimento = ven.codMovimento and
         codCliente = :CODIGO and ((CODPRODUTO = 744) or (CODPRODUTO = 745)) and ven.DATAVENCIMENTO = :vencimento and movd.CONTROLE = :codSoc
       into :V;
      ...
      begin
        ...
        /* Emissao, Data Vencimento, Cód. Cliente, Cód.Cliente */
        execute procedure lancaReceitaSaude(:EMISSAO, :VENCIMENTO, :CODIGO, :CodSoc, 744 , null, null,
        0, :VALOR_P, 0, null, :cCusto, null, null,null,null,null,null);
      end
   end
  end /*fim pcmso */
 end
