...
begin
   ...
   begin
     ...
     VALUES 
       ...
       0, NEW.DATACOMPRA, NEW.N_PARCELA,0, new.CAIXA ,new.N_DOCUMENTO ,new.DATACONSOLIDA);
     i = 1;
   ...
   begin
     ...
     INSERT INTO PAGAMENTO
       ...
       CODCOMPRA , CODALMOXARIFADO, CODCOMPRADOR, CODUSUARIO
       , DATASISTEMA, VALOR_PRIM_VIA, VALOR_RESTO, VALORTITULO, VALORRECEBIDO, JUROS 
       , DESCONTO, PERDA, FUNRURAL, PARCELAS, TROCA,CAIXA, DATAPAGAMENTO ,N_DOCUMENTO,DATACONSOLIDA)
     VALUES 
       (NEW.NOTAFISCAL, NEW.DATACOMPRA, NEW.CODFORNECEDOR, udf_IncMonth(NEW.DATAVENCIMENTO, :i),
       :status_venda, CAST((:i + 1) as CHAR(3)),'1', NEW.CODCOMPRA, NEW.CODCCUSTO, NEW.CODCOMPRADOR, NEW.CODUSUARIO,  
       cast('NOW' as date), :VLR_PRIM_VIA, :VLR_RESTO, :VLR_TITULO, NEW.MULTA_JUROS, 0, 0,0,0, NEW.N_PARCELA,0, :CAIXA, :DTAPAG , new.N_DOCUMENTO,new.DATACONSOLIDA);
     i = i + 1;    
   end
end
