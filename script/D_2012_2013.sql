...
BEGIN
  ...
  codr = 0 ;
  FOR
    select movd.codproduto , movd.preco,movd.preco, movd.precocusto, movd.controle,rec.codrecebimento,rec.datavencimento,  movd.cod_comissao,fo.NOMEFORNECEDOR,
     fo.TIPOFIRMA,fo.CNPJ , prod.valorunitarioatual,cli.ra , cli.razaosocial,  cli.nomecliente ,
     cli.cnpj , cli.situacaoescolar , cli.sexo ,cli.datanasc
   ...
   order by  movd.controle,  cli.nomecliente ,  rec.datavencimento, rec.codrecebimento
       ...
       INTO :codproduto ,:PRECO,:PR , :PRECOCUSTO, :CONTROLE,:codrecebimento, :datavencimento, :COD_COMISSAO,:NOMEFORNECEDOR,:TIPOFIRMA,:CNPJ,
         :VALORUNITARIOATUAL,:ra, :razaosocial ,:NOMECLIENTE ,:CLI_CPF ,:SITUACAOESCOLAR , :SEXO , :datanasc
  DO
  BEGIN
