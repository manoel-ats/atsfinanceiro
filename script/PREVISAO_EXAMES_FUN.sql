CREATE PROCEDURE PREVISAO_EXAMES_FUN (
    dta1 date,
    dta2 date,
    cliente integer,
    clienteproc integer,
...
BEGIN
  /* Recebimento   */
  for select  udf_Left(cli.RA,15)as ra,  cli.RAZAOSOCIAL, prod.CODPRO, prod.PRODUTO, ven.DATAVENDA , prod.cod_comissao , count(prod.CODPRO)
     , movd.historico , cli.nomecliente, cli.CNPJ, cli.INSCESTADUAL,cli.datanasc
      from Venda ven 
