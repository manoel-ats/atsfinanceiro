CREATE OR ALTER PROCEDURE OEZ_PCMSO 
returns (
    ra varchar(10),
...
BEGIN
  ...
  BEGIN
     ...
     e.telefone, e.telefone1,e.telefone2,e.fax,  e.ddd, e.ddd2, e.ddd3, e.ddd1,   e.comple
    from ENDERECOCLIENTE e 

      where e.CODCLIENTE = :codCliente and e.TIPOEND = 0
      into :Endereco, :Numero, :Bairro , :Cidade , :UF , :CEP , :e_mail ,
      :telefone, :telefone1,:telefone2,:fax, :ddd, :ddd2, :ddd3, :ddd1,:comple ;
