...
BEGIN
  ...
  codr = 0 ;
  FOR
    select  movd.preco,movd.preco, movd.precocusto, movd.controle,rec.codrecebimento,rec.datavencimento,  movd.cod_comissao,fo.NOMEFORNECEDOR,
   ...
   order by  movd.controle,  cli.nomecliente ,  rec.datavencimento, rec.codrecebimento
       ...
       INTO :PRECO,:PR , :PRECOCUSTO, :CONTROLE,:codrecebimento, :datavencimento, :COD_COMISSAO,:NOMEFORNECEDOR,:TIPOFIRMA,:CNPJ,
