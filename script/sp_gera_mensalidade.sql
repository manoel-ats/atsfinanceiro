...
begin
    ...
    do begin
      ...
      /* Alterei aqui para não gerar Mensalidade para que tb tem '745 mensalidade Antecipada'  12/07/2011
     /* select first 1 CODPRODUTO FROM PRODUTOS WHERE PRODUTO LIKE 'MENSALIDADE'
        into :codProd;  */
       ...
       /* Verifico se não foi lançado mensalidade neste vencimento */
       Select ven.codVenda from Venda ven, MovimentoDetalhe movd where movd.codMovimento = ven.codMovimento and
         codCliente = :CODIGO and ((movd.codProduto = 744 )or(movd.codProduto = 745 ))and ven.DATAVENCIMENTO = :vencimento and movd.CONTROLE = :codSoc
       into :V;
