...
BEGIN
   ...
   */
   ...
   ,sum(movimentodetalhe.PRECO) /*, pagamento.valorrecebido */
   ,sum(0) /*movimentodetalhe.PRECO --, pagamento.valorrecebido */
   ,sum(pagamento.perda)
 ...
 --  and plano.nome = 'ANGIOLOGIA' OR plano.nome = 'DERMATOLOGIA'
--  AND plano.nome = 'DERMATOLOGIA'
